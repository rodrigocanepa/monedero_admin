...
import 'package:monedero_admin/Dialog/dialogSubirFoto.dart';
...
class _ItemFotoEstablecimientoState extends State<ItemFotoEstablecimiento> {
  ...
  void _getImageGallery() async {
    var image = await ImagePicker.pickImage(source: ImageSource.gallery, maxHeight: 480);

    setState(() {
      widget.function(image, widget.numero, false);
      _image = image;
    });
  }

  void _getImageCamera() async {
    var image = await ImagePicker.pickImage(source: ImageSource.camera, maxHeight: 480);
