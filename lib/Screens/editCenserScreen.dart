...
import 'package:monedero_admin/Items/itemFotosEstablecimiento.dart';
...
class EditCenserScreen extends StatefulWidget {
  ...
  EditCenserScreen({this.function, this.censerModel});
...
class _EditCenserScreenState extends State<EditCenserScreen> {
  ...
  void initState() {
    ...
    for(int i = 0; i < widget.censerModel.photos.length; i++){
      imagesNetwork.add(widget.censerModel.photos[i]);
    }
  ...
  _getFile(File filePath, int number, bool isUploaded){
